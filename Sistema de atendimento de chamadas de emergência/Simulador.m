...
config.nLines112=100;
config.nLinesINEM=100;
config.nOperators112=25;
config.nOperatorsINEM=25;
...
while ( idx_S < length(Start1) )
    ...
    if ( Start1(idx_S) < tfim_ord(idx_R) )
        ...
        if(idx_tfim(idx_R)~=0)
                % Caso seja valido
                [tfim_ord,idx_tfim,Operators112,OperatorsINEM,Lines112,LinesINEM,FilaDeEspera112,FilaDeEsperaINEM,FEINEM112,stateData,wait,End1,Start,last]=release(Operators112, ...
                    OperatorsINEM, ...
                    Lines112, ...
                    LinesINEM,...
                    FilaDeEspera112, ...
